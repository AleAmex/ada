...
// vito, DisableObjectResizing = true per impedire il resizing delle icone
...
FCKConfig.RemoveAttributes = 'alt,class,style,lang,width,height,align,hspace,valign' ;
...
FCKConfig.MediaUploadAllowedExtensions	= ".(aiff|asf|avi|bmp|fla|flv|gif|jpeg|jpg|mid|mov|mp3|mp4|mpc|mpeg|mpg|png|qt|ram|rm|rmi|rmvb|swf|tif|tiff|wav|wma|wmv)$" ;		// empty for all
