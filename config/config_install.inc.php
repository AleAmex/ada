...
define('ADA_COMMON_DB_NAME',  'ada_common_un');
define('ADA_COMMON_DB_USER',  'root');
define('ADA_COMMON_DB_PASS',  'ejOIJXVWTfL01AUb');
...
define('ADA_DEFAULT_TESTER_DB_USER',  'ada_provider0_un');
define('ADA_DEFAULT_TESTER_DB_PASS',  's5GiZswAkwceqYUq');
 ...
 */
if (!defined('HTTP_ROOT_DIR')) define('HTTP_ROOT_DIR','http://127.0.0.1:8080/edsa-ada/'); // *js_import*
 ...
 */
define('ADA_ADMIN_MAIL_ADDRESS','alessandro.amerio@gmail.com');

/**
 * Default noreply mail address
 */
define('ADA_NOREPLY_MAIL_ADDRESS','alessandro.amerio@gmail.com');
